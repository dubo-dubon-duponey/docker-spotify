...
This image is built using: `dubodubonduponey/base:builder-bullseye-2021-06-01` 

The runtime part is based on: `dubodubonduponey/base:runtime-bullseye-2021-06-01`

Both these images are built upon: `dubodubonduponey/debian:bullseye-2021-06-01`, a debootstrapped version of Debian ("bullseye" at this time), built from a snapshot at 2021-06-01.
